      ...
      <div className='container-card'>
        ...
        <div className='card-base'>
          ...
          <div className='area-text mbl-10'>
            <p className='color-primary mb-10 fs-14 font-bold'>Encurtar links</p> {/* Título do cartão */}
        ...
        <div className='card-base'>
          ...
          <div className='area-text mbl-10'>
            <p className='color-primary mb-10 fs-14 font-bold'>Qr code</p> {/* Título do cartão */}
